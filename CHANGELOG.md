...
* `REX` ([cd17f79](https://github.com/QTR-Modding/CommonLibVR/commit/cd17f79a030de4d35e0d890f2358cfcb79674d81))
* `REX` ([29b9ca1](https://github.com/QTR-Modding/CommonLibVR/commit/29b9ca1ff4ef76e3ea5845da4fb80071be72f8b3))
* `SerializationInterface` ([fcbf923](https://github.com/QTR-Modding/CommonLibVR/commit/fcbf923552073182340fcf12681b8b771bd05d61))
* `SerializationInterface` ([323dfa9](https://github.com/QTR-Modding/CommonLibVR/commit/323dfa9ae968e857c2513a4c0cdfc86e5cad7ccd))
* actor funcs ([651afe9](https://github.com/QTR-Modding/CommonLibVR/commit/651afe978f7fd4616b5d66eb57d2ba3ee01f9c87))
* Add `KEEP_FOR_RE` macro to CLIB-VR ([#26](https://github.com/QTR-Modding/CommonLibVR/issues/26)) ([06182ef](https://github.com/QTR-Modding/CommonLibVR/commit/06182ef6913131eb477a6dbf92b4c97b7f446a4a))
* add 1.5.97 IDs if possible ([5655a1a](https://github.com/QTR-Modding/CommonLibVR/commit/5655a1af859478470b24ad05a2ecd6c706525ba2))
* add arrestTarget to AIProcess ([f080217](https://github.com/QTR-Modding/CommonLibVR/commit/f080217bc29f98063f824261d78cae9a29d8ca78))
* add BSGraphics::State::SetCameraData function ([8c8780b](https://github.com/QTR-Modding/CommonLibVR/commit/8c8780b6d78c06e882cb34060d88e197a7008fe1))
* add BSOpenVR::GetCleanIVROverlay ([24bd3ac](https://github.com/QTR-Modding/CommonLibVR/commit/24bd3ac4f53b16af9a0741cf5bdfe3089d5774d5))
* add BSOpenVR::GetRenderTargetSize ([8726ee9](https://github.com/QTR-Modding/CommonLibVR/commit/8726ee9dea1bb57b1e22bfa7fd033467e2391825))
* add CreateDuplicateForm param ([3531be6](https://github.com/QTR-Modding/CommonLibVR/commit/3531be6ab759812cb970d223e466817dc786157f))
* add defines to CMakeLists ([c679be1](https://github.com/QTR-Modding/CommonLibVR/commit/c679be1b674f4c7d7b5dc172c2dcf5085d68b7b8))
* add formatters for NiColor and NiColorA ([2987d13](https://github.com/QTR-Modding/CommonLibVR/commit/2987d13270710db75b0cb99c7f75fa228887a398))
* add GetBodyImpl() ([7880df5](https://github.com/QTR-Modding/CommonLibVR/commit/7880df58607aa0327789c9b2df716ec32ed13be0))
* add getters for BSShaderProperty ([cd3362a](https://github.com/QTR-Modding/CommonLibVR/commit/cd3362a875628d808df242d447f0e22bdea56d45))
* add initial skyrimvresl support ([ad83b61](https://github.com/QTR-Modding/CommonLibVR/commit/ad83b610df60bae67e13a1d1cbeb26d7ed197b9b))
* add initial skyrimvresl support ([fe699b1](https://github.com/QTR-Modding/CommonLibVR/commit/fe699b180597b36d9914c0e88ff664ac33679f60))
* add missing story manager events ([560429c](https://github.com/QTR-Modding/CommonLibVR/commit/560429c23f0b6f3fa8287f34ab6b7285226d43c6))
* add nipoint3 fmt ([4c552f8](https://github.com/QTR-Modding/CommonLibVR/commit/4c552f8bd8015c651968283ee130e45b34854b07))
* add opt in to require minimal VR address lib version ([#48](https://github.com/QTR-Modding/CommonLibVR/issues/48)) ([6b0750a](https://github.com/QTR-Modding/CommonLibVR/commit/6b0750aa6c991b2f6b26b46033e0e51a655c824e))
* add opt in to require minimal VR address lib version ([#48](https://github.com/QTR-Modding/CommonLibVR/issues/48)) ([#50](https://github.com/QTR-Modding/CommonLibVR/issues/50)) ([735fa6d](https://github.com/QTR-Modding/CommonLibVR/commit/735fa6dae8ec72966ee02673dd689c6516d49f71))
* add options to CMakeLists ([cf2128c](https://github.com/QTR-Modding/CommonLibVR/commit/cf2128cff50a07e533d84cb267fb9a503fbd1863))
* add RE for some shader properties, utility shader and shader emitters ([4a90d92](https://github.com/QTR-Modding/CommonLibVR/commit/4a90d92702d8bdc455c2b16e447d7940ab9eb3ca))
* add runtime HUD_MESSAGE_TYPE getters ([e0c1da7](https://github.com/QTR-Modding/CommonLibVR/commit/e0c1da776dc3d0be0d41dcf70f3d788315e61f69))
* add SelectedRefHandle address for 1130 ([97b7f3c](https://github.com/QTR-Modding/CommonLibVR/commit/97b7f3cf35f0a3858148cc0f0094064000391ad3))
* add Sky::IsDaytime ([8e237b5](https://github.com/QTR-Modding/CommonLibVR/commit/8e237b5dfe2aaaf780b97dd61d6ca1c624d9e7a8))
* add some vtables ([990aa2c](https://github.com/QTR-Modding/CommonLibVR/commit/990aa2c903abb4f3b992012b9f4616fac3f06f3c))
* add SSE 1170 ([c5d4f17](https://github.com/QTR-Modding/CommonLibVR/commit/c5d4f170b7d37658d6988f201aaabaa973695e4a))
* add std::format specializations ([46b48f9](https://github.com/QTR-Modding/CommonLibVR/commit/46b48f9ca601dcfec2046ed89bb113963561340b))
* add support for cs imgui ([cac175f](https://github.com/QTR-Modding/CommonLibVR/commit/cac175fef91df22ae68f185040f093dae601add2))
* add support for plugin install and package ([13bd549](https://github.com/QTR-Modding/CommonLibVR/commit/13bd5496df5ef969606883c9e54b53e83f6f0041))
* add terrain RE ([b944c26](https://github.com/QTR-Modding/CommonLibVR/commit/b944c268414dd714a03dc54ab4a9b43eaa442a2a))
* add total member for NiFile ([c96f770](https://github.com/QTR-Modding/CommonLibVR/commit/c96f770fc920864696e7d1524ce5c43c3b829fd0))
* add total member for NiFile ([6599897](https://github.com/QTR-Modding/CommonLibVR/commit/6599897791e500d3a27c3c98b3d0b1a39f8e2bdc))
* add Vector3 fmt ([771a38a](https://github.com/QTR-Modding/CommonLibVR/commit/771a38ae5510ac9cabd2be1b2d613ad756bd7d94))
* add verifying safe_write and safe_fill ([922ea16](https://github.com/QTR-Modding/CommonLibVR/commit/922ea16222102251a2ab2d9143344526012189fc))
* add VR Bow State RE ([#46](https://github.com/QTR-Modding/CommonLibVR/issues/46)) ([8e2e2fd](https://github.com/QTR-Modding/CommonLibVR/commit/8e2e2fd8371ada5066215ca80aa4d5c4da06fb9d))
* Add VR Bow State RE ([#47](https://github.com/QTR-Modding/CommonLibVR/issues/47)) ([2afe3d5](https://github.com/QTR-Modding/CommonLibVR/commit/2afe3d5c56b17cf4e06612a316a5548c367d2769))
* add vr HUD_MESSAGE_TYPE ([9558939](https://github.com/QTR-Modding/CommonLibVR/commit/9558939c7e748be3505a7bdad6ed3163417753c9))
* add vr HUD_MESSAGE_TYPE ([e09c17c](https://github.com/QTR-Modding/CommonLibVR/commit/e09c17c33f6739492d4f1fc82fcd61bb76c08f9a))
* Additions for PBR. ([0d00e82](https://github.com/QTR-Modding/CommonLibVR/commit/0d00e8275247e13fedca98d4a717ad2c7ed6a36e))
* BehaviourGraph activeNodes data. ([629a21f](https://github.com/QTR-Modding/CommonLibVR/commit/629a21fe019ca567dd2a2caf023bc6a5136d7994))
* better handling of toml paths ([abce9f6](https://github.com/QTR-Modding/CommonLibVR/commit/abce9f6bbad0610d36d02a8366cebc7f26d9cb98))
* bhkRigidBodyT ([cd83eb5](https://github.com/QTR-Modding/CommonLibVR/commit/cd83eb52bcd4d930434838fe9c414d31640e3fe3))
* BSComputeShader and some improvements for BSImagespaceSahder. ([8938850](https://github.com/QTR-Modding/CommonLibVR/commit/8938850441f46d1a5db5e606e6d327ee8b3e0709))
* BSImagespaceShader RE. ([73f288f](https://github.com/QTR-Modding/CommonLibVR/commit/73f288fc13737f4f224bbbcb4065e7e05e91ccf6))
* change ShaderFlags to stl:enumeration ([2cce664](https://github.com/QTR-Modding/CommonLibVR/commit/2cce664040e9338130ee4a51f87a2a1b6cba9f15))
* combat stuff ([9f67e4b](https://github.com/QTR-Modding/CommonLibVR/commit/9f67e4b91d698e8591cb71dfd5fab8159e9c6b4d))
* convert stl::enumeration to REX::EnumSet ([7973641](https://github.com/QTR-Modding/CommonLibVR/commit/797364141a3b2791392e6ce5399acb6039426438))
* don't build by default when subproject ([d01ae9b](https://github.com/QTR-Modding/CommonLibVR/commit/d01ae9bb8127f106d29214bb1b62b7bf3a6ca7c8))
* even more combat RE ([ed7e087](https://github.com/QTR-Modding/CommonLibVR/commit/ed7e087aa4501481ba23e3ba0707a8dec68ac273))
* expose VRcompiledFileCollection ([6089216](https://github.com/QTR-Modding/CommonLibVR/commit/6089216a56af68f4527932ec96bf2f76ac864346))
* improve settings ([ebfda8b](https://github.com/QTR-Modding/CommonLibVR/commit/ebfda8b7d4e085dbeb6f028286fa3c217826e019))
* inline all offsets and remove Offsets.h ([9f44259](https://github.com/QTR-Modding/CommonLibVR/commit/9f44259eed6696b712a9290d9100572417c323af))
* make log default to true ([673d3da](https://github.com/QTR-Modding/CommonLibVR/commit/673d3daee663eeae525834bb82cb5f6fde2143c2))
* migrate to toml11, add toml saving ([04d5a27](https://github.com/QTR-Modding/CommonLibVR/commit/04d5a27b9cd8784b0563e193010068ec1ca353df))
* misc ([a371f83](https://github.com/QTR-Modding/CommonLibVR/commit/a371f83d02be628b96de22d2e792c8c86169088d))
* misc ([93d73f1](https://github.com/QTR-Modding/CommonLibVR/commit/93d73f18d24105067c5f5fbdf5e206b6539a6928))
* misc RE ([80bea41](https://github.com/QTR-Modding/CommonLibVR/commit/80bea4161ee58fe3b0738ecd9f217cd3ee6cae80))
* misc RE ([2fa9e3c](https://github.com/QTR-Modding/CommonLibVR/commit/2fa9e3cbb2182712640a8f65301aa77c2aa99065))
* misc RE ([97f711a](https://github.com/QTR-Modding/CommonLibVR/commit/97f711a28c59b4b61a68c87dcbe2fd3f92fc11f7))
* Missing CameraStates. ([24537fb](https://github.com/QTR-Modding/CommonLibVR/commit/24537fb74c3f4453d8a9ee85e8c9e6af35a75182))
* more ([978b93e](https://github.com/QTR-Modding/CommonLibVR/commit/978b93e1abe60a809ff95bb0258dc20859e77f17))
* more combat ([baf0b07](https://github.com/QTR-Modding/CommonLibVR/commit/baf0b074a8ef5324bf2cc127e3f2f90dd8cf68f9))
* more misc stuff ([060ab3f](https://github.com/QTR-Modding/CommonLibVR/commit/060ab3f099874d845bad1456d9120d04cd93e296))
* more stuff ([8c2de4a](https://github.com/QTR-Modding/CommonLibVR/commit/8c2de4aca4bc6703d85637537a027f82fef9c2e2))
* port api helpers from commonlibf4 ([692f213](https://github.com/QTR-Modding/CommonLibVR/commit/692f213d79a2049fa7b1ad7dc46d47bf06ac8416))
* portals stuff RE. ([677e337](https://github.com/QTR-Modding/CommonLibVR/commit/677e337d1f2473d112eaa44b335878977af2fec0))
* portals stuff RE. ([1ac5d9d](https://github.com/QTR-Modding/CommonLibVR/commit/1ac5d9d12ca828300194be193b974818d208816c))
* RE BSOpenVR ([#22](https://github.com/QTR-Modding/CommonLibVR/issues/22)) ([759b592](https://github.com/QTR-Modding/CommonLibVR/commit/759b592de73f05cfac229bdbb03bf034aa66c1d2))
* RE BSOpenVR ([#45](https://github.com/QTR-Modding/CommonLibVR/issues/45)) ([56938a9](https://github.com/QTR-Modding/CommonLibVR/commit/56938a9cd74d8d76661dace91e373eef0418e966))
* re COpenVRContext ([ee8cd57](https://github.com/QTR-Modding/CommonLibVR/commit/ee8cd57747630b8dd1059bd67f10d3ff9439d142))
* RE ImageSpaceManager rect members ([0acb02b](https://github.com/QTR-Modding/CommonLibVR/commit/0acb02b7e09a63cf063dfb6a731c604969b9f593))
* RE NiPick ([711bae5](https://github.com/QTR-Modding/CommonLibVR/commit/711bae55f0fe702992aba1c781b3e602a615fcf4))
* RE NiTriShape ([e906fbd](https://github.com/QTR-Modding/CommonLibVR/commit/e906fbda7cfdbbef1c30935083a006cf3f48991a))
* Relocation::write_func ([76e826d](https://github.com/QTR-Modding/CommonLibVR/commit/76e826dc759b95eed50f6c1b57f14a82b1a355b4))
* remove `stl::enumeration` ([37210f9](https://github.com/QTR-Modding/CommonLibVR/commit/37210f94209f4fffc70a50ad3d4db933b367ab53))
* REX json impl ([5e597e8](https://github.com/QTR-Modding/CommonLibVR/commit/5e597e86f93da31275781bc4b0dcc553dc441b72))
* REX: initial ini, toml support ([317481b](https://github.com/QTR-Modding/CommonLibVR/commit/317481ba152f21fcc2cb120df4580b1016d51d33))
* separate REX defs; ini, toml, and json work ([cc0fe3c](https://github.com/QTR-Modding/CommonLibVR/commit/cc0fe3cb1179ee9152387775b12e70cb676c49d3))
* shadow lights RE. ([c679dd8](https://github.com/QTR-Modding/CommonLibVR/commit/c679dd8ecf72eb51a96a1d046d4d28d72dc014b4))
* simplify formatter's ([dcc6022](https://github.com/QTR-Modding/CommonLibVR/commit/dcc6022f0950a31d2294228839d9bbe300b29562))
* swap renderTargets to use RENDER_TARGET ([0b92b1a](https://github.com/QTR-Modding/CommonLibVR/commit/0b92b1aad79c22b9a0620c4bdd244e9f4ad94fea))
* sync with po3 ([61e5172](https://github.com/QTR-Modding/CommonLibVR/commit/61e51729a2f793c86ba85b2b4b8545aeeebc769e))
* terrain system, tesfile, console RE ([#87](https://github.com/QTR-Modding/CommonLibVR/issues/87)) ([801ec29](https://github.com/QTR-Modding/CommonLibVR/commit/801ec29d8dd19c553bafc14f77853dbe5cb5acb3))
* use `REX::EnumSet` + clang format ([163a507](https://github.com/QTR-Modding/CommonLibVR/commit/163a507d947d45493aed684c24cf37069ba04266))
* **VR:** add bsshadowlight RE ([4833031](https://github.com/QTR-Modding/CommonLibVR/commit/48330316d24baf2411577bcbb2c779e177c997ba))
* **VR:** add GetActiveEffectList shim ([#115](https://github.com/QTR-Modding/CommonLibVR/issues/115)) ([7450dcf](https://github.com/QTR-Modding/CommonLibVR/commit/7450dcfb37f7ba68043fe3833fdbfba97f3fd489))
* **VR:** add missing ISCopyDepthBuffer_DR ([f343b8c](https://github.com/QTR-Modding/CommonLibVR/commit/f343b8cf75cace4ff942ef744ea34c406aa7f8e2))
* **VR:** add packed ImageSpaceEffectEnum ([d50cd96](https://github.com/QTR-Modding/CommonLibVR/commit/d50cd96b8016a5ecf89c744abe860bfb0e23e98c))
* **VR:** add rendertargets ([784614c](https://github.com/QTR-Modding/CommonLibVR/commit/784614c735040dde053ab5a9cd02f66ddbd40144))

### Bug Fixes

* add file nullptr check ([543c8e9](https://github.com/QTR-Modding/CommonLibVR/commit/543c8e99ddea94cf109968e8f0839862f5e516a9)), closes [#9](https://github.com/QTR-Modding/CommonLibVR/issues/9)
* add getters to BSShadowDirectionalLight ([#81](https://github.com/QTR-Modding/CommonLibVR/issues/81)) ([379af33](https://github.com/QTR-Modding/CommonLibVR/commit/379af33c1f391ed0e87da009044dedf20b030683))
* add includes, minor tweaks ([1b8dc45](https://github.com/QTR-Modding/CommonLibVR/commit/1b8dc45fb0a13a0851571f7a57d4377232848f5f))
* add missing a_userEvent parameter to AddButtonEvent ([794e002](https://github.com/QTR-Modding/CommonLibVR/commit/794e002091e1b8ee084ad3d4f2be3679111652c2))
* add missing BSShaderProperty funcs ([#58](https://github.com/QTR-Modding/CommonLibVR/issues/58)) ([2f0735a](https://github.com/QTR-Modding/CommonLibVR/commit/2f0735ad57b5cdbbfd427ce07ef92ca4f0249fc2))
* add missing ExtraLevCreaModifier destructor implementation ([53e7de3](https://github.com/QTR-Modding/CommonLibVR/commit/53e7de3d3d03466f0c70de86903830191c54ba9b))
* add missing GetRuntimeData accessor to FaderMenu ([8f5cd17](https://github.com/QTR-Modding/CommonLibVR/commit/8f5cd175b8e1f899732f38031003e79b3ec2e2a7))
* add missing handler ([4a4ffb9](https://github.com/QTR-Modding/CommonLibVR/commit/4a4ffb96a6ef6856c53f3c51074c8fb83e7c14f0))
* add some runtime protection and fix some possible crashes ([d8cd383](https://github.com/QTR-Modding/CommonLibVR/commit/d8cd38319725f8e0f312f146935a9c3730f75ce2))
* added WMR controller values to INPUT_DEVICE enum ([9b55449](https://github.com/QTR-Modding/CommonLibVR/commit/9b554497a73312512f47c1c799d76bdd224046db))
* added WMR controller values to INPUT_DEVICE enum ([618db16](https://github.com/QTR-Modding/CommonLibVR/commit/618db16f21d2ea4b99e2ff9940ff9bbe0240380f))
* adjust TESForm Recordflag enum ([21c1c39](https://github.com/QTR-Modding/CommonLibVR/commit/21c1c3976998c584481f3a77ba62880355de2879))
* AE relocation ID for BGSFootstepManager::GetSingleton() ([#76](https://github.com/QTR-Modding/CommonLibVR/issues/76)) ([52f49e8](https://github.com/QTR-Modding/CommonLibVR/commit/52f49e8b8c01eed4a35e2b02b0d435c27e3cd217))
* BGSDefaultObjectManager::GetObject lookup failure ([#98](https://github.com/QTR-Modding/CommonLibVR/issues/98)) ([c41cdb7](https://github.com/QTR-Modding/CommonLibVR/commit/c41cdb7a16d90e061a2fae963d4d7eab70717bf4))
* BSSmallBlockAllocator.h ([#88](https://github.com/QTR-Modding/CommonLibVR/issues/88)) ([8319090](https://github.com/QTR-Modding/CommonLibVR/commit/8319090b0db4a9de6ffd920d16cdcec9a6cb769d))
* BSSmallBlockAllocator.h ([#89](https://github.com/QTR-Modding/CommonLibVR/issues/89)) ([2c21b06](https://github.com/QTR-Modding/CommonLibVR/commit/2c21b06f0222ba1a0947ee07b613ac652ee26b54))
* build and follow sse naming standard ([b191316](https://github.com/QTR-Modding/CommonLibVR/commit/b19131697b9ffaa6e9c12f0b9df00349d50323e8))
* ButtonEvent inheritence ([7ce496a](https://github.com/QTR-Modding/CommonLibVR/commit/7ce496a90b09e3e0e47b062a4fc954a972613cc7))
* camera states ([8a01918](https://github.com/QTR-Modding/CommonLibVR/commit/8a0191840cb9b008aff2b5733da0419a3c74cad9))
* clang-cl ([65b9e19](https://github.com/QTR-Modding/CommonLibVR/commit/65b9e1981d31e1afe1f01c49579c2391d0d5806e))
* clang-cl warnings ([#83](https://github.com/QTR-Modding/CommonLibVR/issues/83)) ([6f2b8f6](https://github.com/QTR-Modding/CommonLibVR/commit/6f2b8f699121714f6a96cd0f3d87576c2a5e00f8))
* clarify LocalMapCullingProcess cross-VR size assertion ([9228685](https://github.com/QTR-Modding/CommonLibVR/commit/9228685cf7fce73f9d791aa969cba5bf53783724)), closes [#107](https://github.com/QTR-Modding/CommonLibVR/issues/107)
* consistency ([af39065](https://github.com/QTR-Modding/CommonLibVR/commit/af3906508198c355c614a7ce7edda6de63130b15))
* correct BSTimer size and Explosion members ([957c3b0](https://github.com/QTR-Modding/CommonLibVR/commit/957c3b00d9237cd1010c5853ac838a09cdcb7268))
* correct control map AE version comparison ([#32](https://github.com/QTR-Modding/CommonLibVR/issues/32)) ([a5859e4](https://github.com/QTR-Modding/CommonLibVR/commit/a5859e42cbd83421527b5816054e346a78d52411))
* correct RUNTIME_DATA_ACCESSOR macro for State.h GetRuntimeData ([c1e2ef8](https://github.com/QTR-Modding/CommonLibVR/commit/c1e2ef8ecfea7510e06131de69b22a5cda526d34))
* correct vrContext ([162c035](https://github.com/QTR-Modding/CommonLibVR/commit/162c035f239a27e4ae76b4fb5c093569bacf56c5))
* disable REX toml Save functions ([e0d9e73](https://github.com/QTR-Modding/CommonLibVR/commit/e0d9e739b427bf2c188827196a2bd7285676cfae))
* enable conforming preprocessor for STATIC_ASSERT_SIZE macro ([113c400](https://github.com/QTR-Modding/CommonLibVR/commit/113c400d6cacf4605feb1b421a88cf2158c2e271))
* Fix `HUDMenu` name ([#61](https://github.com/QTR-Modding/CommonLibVR/issues/61)) ([1fe0613](https://github.com/QTR-Modding/CommonLibVR/commit/1fe061326d8875603b22d8d014d72abbd5368cac))
* fix 1130 offsets and flatrim config ([05d81a1](https://github.com/QTR-Modding/CommonLibVR/commit/05d81a13693652bf63bd34fc6efd994a0d6644db))
* fix ActorMagicCaster::Update offset ([#75](https://github.com/QTR-Modding/CommonLibVR/issues/75)) ([943c12e](https://github.com/QTR-Modding/CommonLibVR/commit/943c12e7a5c8ba05b4867c568cb51022fe8e8530))
* fix ae ID ([#80](https://github.com/QTR-Modding/CommonLibVR/issues/80)) ([539d4ce](https://github.com/QTR-Modding/CommonLibVR/commit/539d4ce50969e8d23f4d507a7bc3dd955a4de93f))
* fix assignment of VRcompiledFileCollection ([21ef754](https://github.com/QTR-Modding/CommonLibVR/commit/21ef754b4837a027f5a2b3c9879b75886dce721d))
* fix bad offset for VR NiAVObject userData ([a89eeb9](https://github.com/QTR-Modding/CommonLibVR/commit/a89eeb96b1375dcdff2e0c0ed05eb4b505689e90))
* fix BGSDefaultObjectManager array iteration ([dfedc5e](https://github.com/QTR-Modding/CommonLibVR/commit/dfedc5e3beef8703c1ad92c250a758d47345fa8b))
* fix BSGraphics::Renderer for AE1130 ([738afc4](https://github.com/QTR-Modding/CommonLibVR/commit/738afc457fdeba050ce328f15225aa3cde674187))
* fix bsinputeventqueue static_asserts ([9341642](https://github.com/QTR-Modding/CommonLibVR/commit/9341642fa25412cff407f4215686460f85868876))
* fix BSPCGamepadDeviceHandler runtime offsets ([e840bca](https://github.com/QTR-Modding/CommonLibVR/commit/e840bca8fe345242ccfcef0b3ee7b0b3fe5028aa))
* fix BSShaderMaterial memory allocation ([a537473](https://github.com/QTR-Modding/CommonLibVR/commit/a53747388e051060f3cbbf3e4a1e53049fb89fc1))
* fix BSTriShape runtime offsets ([e11ac6e](https://github.com/QTR-Modding/CommonLibVR/commit/e11ac6e9d892c9d39857c477120aeb56fe6feaca))
* fix check for successful ID mapping ([#69](https://github.com/QTR-Modding/CommonLibVR/issues/69)) ([4aac68c](https://github.com/QTR-Modding/CommonLibVR/commit/4aac68cf2c8277be26975eafb22d1e1b947abc5a))
* fix compilation error ([3936bcb](https://github.com/QTR-Modding/CommonLibVR/commit/3936bcb8cb2d97fad006597b5058c908aa7a036c))
* fix compilation error ([99f0393](https://github.com/QTR-Modding/CommonLibVR/commit/99f03932f7451f23add1b54b8bf940074fe3700d))
* fix compilation errors ([9214fe7](https://github.com/QTR-Modding/CommonLibVR/commit/9214fe709d78a1fedcc711b71ca37637378a1d40))
* fix compile errors ([5810743](https://github.com/QTR-Modding/CommonLibVR/commit/581074333616630eae3318df4fbfaf59919066c1))
* fix compile errors ([612bf3d](https://github.com/QTR-Modding/CommonLibVR/commit/612bf3d1a7eb0cc05029ee5d0eba3301b91e1c74))
* fix compile errors ([#63](https://github.com/QTR-Modding/CommonLibVR/issues/63)) ([853cd7a](https://github.com/QTR-Modding/CommonLibVR/commit/853cd7ae01113fb36850ba8a8c1635a34cc6fb81))
* fix ControlMap singleton ID ([9646bdb](https://github.com/QTR-Modding/CommonLibVR/commit/9646bdb42a02ad8dc2d58c894013693a84ec2cc3))
* fix CTD on WorldSpaceMenu ([befa2de](https://github.com/QTR-Modding/CommonLibVR/commit/befa2dec6e010cd608866331c5a60dedcc2d2026))
* fix exclusive build for FLAT or VR ([#57](https://github.com/QTR-Modding/CommonLibVR/issues/57)) ([2a0f382](https://github.com/QTR-Modding/CommonLibVR/commit/2a0f382515b27b0b7e433e28ee163679b10b9f68))
* fix fmt compile errors ([5949aa0](https://github.com/QTR-Modding/CommonLibVR/commit/5949aa0542d0d8b7a2b564691de6923a47732e9a))
* fix location of vr alphaBlendModeExtra ([b17ee0a](https://github.com/QTR-Modding/CommonLibVR/commit/b17ee0a896cb4235a44060b071fbb5f1a7ee34a5))
* fix logger directory for VR ([054e1e2](https://github.com/QTR-Modding/CommonLibVR/commit/054e1e20b2a26ffa488e96bbc7862fab19ad4623))
* fix MapMenu getters ([#60](https://github.com/QTR-Modding/CommonLibVR/issues/60)) ([34b59a3](https://github.com/QTR-Modding/CommonLibVR/commit/34b59a398ca7e84c247d09712b77e780e4b0b40e))
* fix NiParticle runtime offsets for VR ([e3b7990](https://github.com/QTR-Modding/CommonLibVR/commit/e3b7990827c3fe18b2f75921c2aafa59cb38ce2c))
* fix NPE in TypeInfo.cpp ([a62791c](https://github.com/QTR-Modding/CommonLibVR/commit/a62791cbcb68bd796b303ae7d1a25829d49c6b12))
* fix offset for VR Player Runtime Data ([#85](https://github.com/QTR-Modding/CommonLibVR/issues/85)) ([394b105](https://github.com/QTR-Modding/CommonLibVR/commit/394b105e0ab1dbc249d9e848904118c04c125099))
* fix player struct alignment for AE ([#52](https://github.com/QTR-Modding/CommonLibVR/issues/52)) ([9704d50](https://github.com/QTR-Modding/CommonLibVR/commit/9704d50be5b5841541beaeaf9d615993c4a494db))
* fix playerCamera ([8b55358](https://github.com/QTR-Modding/CommonLibVR/commit/8b553586220d842358059a34b2de8bdcc7d6a1e7))
* fix playercharacter and controlmap offsets ([cab9f74](https://github.com/QTR-Modding/CommonLibVR/commit/cab9f743fe5a5c70db3ca9b1857ec079738b5ffa))
* fix PlayerCharacter inheritence and sizes ([c836485](https://github.com/QTR-Modding/CommonLibVR/commit/c83648537df2beb4dd9649aa9817094ad3104cb5))
* fix PlayerCharacter::ByCharGenFlag enum size ([2637cd2](https://github.com/QTR-Modding/CommonLibVR/commit/2637cd2f22ce40fec807406593363c37be3bcf3a))
* fix potential symbol conflict ([360f646](https://github.com/QTR-Modding/CommonLibVR/commit/360f6463ed78c62678981a3494c5a3617535a466))
* fix relid regressions from merge ([c0c5131](https://github.com/QTR-Modding/CommonLibVR/commit/c0c5131d6f5a70751cd972170e968ebde03684c1))
* fix renderer offsets ([6ccb57a](https://github.com/QTR-Modding/CommonLibVR/commit/6ccb57a73fe025d441b1ed3c382710dd1fca2f4e))
* fix return path compile error ([e6eadfc](https://github.com/QTR-Modding/CommonLibVR/commit/e6eadfc65fab424fb4b239c63eb8dfb930080943))
* fix runtime offsets for BSShadowLight ([c40cf40](https://github.com/QTR-Modding/CommonLibVR/commit/c40cf40c464ad8a644175f131a06ceba3ea44ba2))
* fix runtime offsets for NiParticles ([1fab24c](https://github.com/QTR-Modding/CommonLibVR/commit/1fab24cf7cdbfc7dd97f456f9ae464531b100f8c))
* fix skyrimvresl VRcompiledFileCollection ([0dc0343](https://github.com/QTR-Modding/CommonLibVR/commit/0dc0343a70b46ef4815d8f03c2e493180575a0ac))
* fix support for fmt10 ([2b3e1f6](https://github.com/QTR-Modding/CommonLibVR/commit/2b3e1f63e438f2cc0effdf207863edc7e12dc9f3))
* fix vfunc indexing for Flatrim ([d970ed2](https://github.com/QTR-Modding/CommonLibVR/commit/d970ed21ea09ce80e34103fab0683457ef3ecdf6))
* fix virtual functions for VR ([fcf1b4c](https://github.com/QTR-Modding/CommonLibVR/commit/fcf1b4c777aa732ae68f92e8cd0c88b7fd39ac9f))
* fix VR module detection lost during qudix refactor ([cf9a3b8](https://github.com/QTR-Modding/CommonLibVR/commit/cf9a3b803bef6f6d07e5abc28af41b9c0e14f333))
* fix weather types ([a9bc9fe](https://github.com/QTR-Modding/CommonLibVR/commit/a9bc9fe07ed912aeb0319a6c1992392d720e5592))
* fix`InputContext::GetNumDeviceMappings()` ([#39](https://github.com/QTR-Modding/CommonLibVR/issues/39)) ([285bccf](https://github.com/QTR-Modding/CommonLibVR/commit/285bccffe7f10884940444a2f6ad079d921127bd))
* fixed setting constant buffers in VR. ([#64](https://github.com/QTR-Modding/CommonLibVR/issues/64)) ([89bc8b4](https://github.com/QTR-Modding/CommonLibVR/commit/89bc8b425555cf4e6e7ce1079e5f6bdeac969e97))
* fmt to std if format lib is defined ([#82](https://github.com/QTR-Modding/CommonLibVR/issues/82)) ([2e8e84e](https://github.com/QTR-Modding/CommonLibVR/commit/2e8e84ec0801dc50ef1a8b9afec62f2e606e48c5))
* GetActiveEffectList and Actor inheritance([#117](https://github.com/QTR-Modding/CommonLibVR/issues/117)) ([f039dcf](https://github.com/QTR-Modding/CommonLibVR/commit/f039dcf97d2e6d0fa7bffd8f1f71f137749ea6df))
* global logger name is case sensitive ([2839cb7](https://github.com/QTR-Modding/CommonLibVR/commit/2839cb701544b2794f1454fcac0449dfaec49144))
* include ([0abd01b](https://github.com/QTR-Modding/CommonLibVR/commit/0abd01b103991733f379327c2d84432abb992766))
* includes ([1eb1bd2](https://github.com/QTR-Modding/CommonLibVR/commit/1eb1bd2668c3678aa48489b86e38f6e30bf486b2))
* init-ing logger too early ([0b0c1f8](https://github.com/QTR-Modding/CommonLibVR/commit/0b0c1f898268fb64116130d83aba4d52963282d9))
* make shadowstate utils VR compatible ([#56](https://github.com/QTR-Modding/CommonLibVR/issues/56)) ([4fba153](https://github.com/QTR-Modding/CommonLibVR/commit/4fba153e75fa2941ab72b5e6da9f280494f52cbd))
* make xmake rex options consistent ([02a517e](https://github.com/QTR-Modding/CommonLibVR/commit/02a517e6eab53852b4031d5fe07d949d2dc4a747))
* **MenuCursor:** fix runtime data use ([c1a2059](https://github.com/QTR-Modding/CommonLibVR/commit/c1a20597dd68ae2397290a2b7fb40e1a73b82aca))
* missing includes ([dc4c411](https://github.com/QTR-Modding/CommonLibVR/commit/dc4c4113b7ec728b2f679ddc41f9dc827dc0a2e2))
* move includes ([6cc6761](https://github.com/QTR-Modding/CommonLibVR/commit/6cc67610c74c906962766b761aaae45f4d68b2b5))
* move REL::Module::reset outside of testing definition ([#53](https://github.com/QTR-Modding/CommonLibVR/issues/53)) ([93d8b8f](https://github.com/QTR-Modding/CommonLibVR/commit/93d8b8f05ae8f49d3463708cdcbe003964b06149))
* move utils to correct place ([813dd0a](https://github.com/QTR-Modding/CommonLibVR/commit/813dd0ac817bc16d83b9116dbb83f30a0ad0597b))
* move utils to correct place ([#59](https://github.com/QTR-Modding/CommonLibVR/issues/59)) ([d4e2b1e](https://github.com/QTR-Modding/CommonLibVR/commit/d4e2b1e396791440a37fefe3db584cc429429eb0))
* only allow default log if 1.6.x support is enabled ([c34f51e](https://github.com/QTR-Modding/CommonLibVR/commit/c34f51e203d0881d0bdc08de44c3fd6ad9e2a2af))
* pass by reference ([0615cc7](https://github.com/QTR-Modding/CommonLibVR/commit/0615cc70ef78a1aba3f93428573f8e5f74c2fd7a))
* proper handling for long toml paths ([c160aa5](https://github.com/QTR-Modding/CommonLibVR/commit/c160aa5d315aaca5dedd58410cdf7af26cd5bfa8))
* RE ImageSpaceManager for VR ([0f756f0](https://github.com/QTR-Modding/CommonLibVR/commit/0f756f04088d6ce9fd005ab60d460754014feb10))
* remove const from EMPTY by Nukem ([#96](https://github.com/QTR-Modding/CommonLibVR/issues/96)) ([994077a](https://github.com/QTR-Modding/CommonLibVR/commit/994077ae42219692c812171a8de5e5939b78aff1))
* remove deprecated Actor::GetRider ([cd43719](https://github.com/QTR-Modding/CommonLibVR/commit/cd437192789620935eb8652bb39b89e915a92959))
* remove duplicate func ([d9647e9](https://github.com/QTR-Modding/CommonLibVR/commit/d9647e99cffa6f33655ab9665bab93429bb8380a))
* remove temp debug output ([ee7778d](https://github.com/QTR-Modding/CommonLibVR/commit/ee7778dff172368154835ce00b3b4596d356a11e))
* require use of GetRuntimeData methods ([e8ec7cc](https://github.com/QTR-Modding/CommonLibVR/commit/e8ec7cc136bf59af0e7ef1bb45e5a3c946c8fe4f))
* resolve post-merge compilation issues ([1da4895](https://github.com/QTR-Modding/CommonLibVR/commit/1da4895d5d71668407ad0d1e11bd8f22a8f5259e))
* revert ini library to simpleini ([402de93](https://github.com/QTR-Modding/CommonLibVR/commit/402de9309a3013b7d0973a2a78f4e95f0b02bb28))
* revert key type change ([e1d1b0c](https://github.com/QTR-Modding/CommonLibVR/commit/e1d1b0c7e790489cd529b82c5d2477f91a4435bd))
* Script::CompileAndRun_Impl and BSScaleformTranslator::GetCachedString for AE1130 ([f7dec1c](https://github.com/QTR-Modding/CommonLibVR/commit/f7dec1cbe91473105f42d159f02b697b55b5dd63))
* sort xmake options ([30fe805](https://github.com/QTR-Modding/CommonLibVR/commit/30fe80560f88860cc3591de38aa8bcb90ce947d3))
* support non-ae ([9fe9130](https://github.com/QTR-Modding/CommonLibVR/commit/9fe9130d9e04f7e79740566efb2dbf3df428c113))
* switch to directx toolkit and simplemath ([bb1c575](https://github.com/QTR-Modding/CommonLibVR/commit/bb1c575855c402dc6f064747938bc4f37d8a691f))
* sync Actor::Unk_117 with flat ([162af97](https://github.com/QTR-Modding/CommonLibVR/commit/162af97a709b8d07e94d8966e6d355d044bbbca5))
* TESCameraState vfunc inheritance ([1117d28](https://github.com/QTR-Modding/CommonLibVR/commit/1117d28d96fc744467e73b3b90d1bf267178f326))
* toml save improvements ([8b086e5](https://github.com/QTR-Modding/CommonLibVR/commit/8b086e5e72d058ed079b6424c9fdbb8b384244b3))
* update INPUT_DEVICES ([687930b](https://github.com/QTR-Modding/CommonLibVR/commit/687930b433091305a995744d57a287ae536a1192))
* update offsets for main.h in VR ([9487609](https://github.com/QTR-Modding/CommonLibVR/commit/9487609ee5c03c405519a6944a6aeb6bb0cc8dd0))
* use FLAT size for SE/AE in static_assert ([5d341d4](https://github.com/QTR-Modding/CommonLibVR/commit/5d341d47108de8f1e70de7db9fa8244d34544fd6))
* use REX::W32 instead of simplemath to fix BSShadowLight build issue ([#44](https://github.com/QTR-Modding/CommonLibVR/issues/44)) ([8e42371](https://github.com/QTR-Modding/CommonLibVR/commit/8e42371362b17770a6ad389f48f4a6fdca998e55))
* use runtime version of currentProcess ([3d05419](https://github.com/QTR-Modding/CommonLibVR/commit/3d054198ecb4ef3ff9157a60fd080969f570a8ad))
* user config no longer overrides base config ([9c9e481](https://github.com/QTR-Modding/CommonLibVR/commit/9c9e481472451d022c1218453e127c6c495f2e6e))
* vr specific changes with merge ([b75853e](https://github.com/QTR-Modding/CommonLibVR/commit/b75853e0d0d247b82fb5336f34252401de13e288))
* **VR:** fix BGSShaderParticleGeometryData RE ([f77c621](https://github.com/QTR-Modding/CommonLibVR/commit/f77c621758ce61f6b7ece0237c9517aa07332aab))
* **VR:** keycode inheritance in ButtonEvent ([7994cde](https://github.com/QTR-Modding/CommonLibVR/commit/7994cdea317e8eea452c1fb7f85e79a7fb107daa))
* xmake merge ([#78](https://github.com/QTR-Modding/CommonLibVR/issues/78)) ([8593e41](https://github.com/QTR-Modding/CommonLibVR/commit/8593e41c1f780b5b16b227f4f62e574d01e0ac3d))
* **xmake:** Add preprocessor flag ([#116](https://github.com/QTR-Modding/CommonLibVR/issues/116)) ([ad86065](https://github.com/QTR-Modding/CommonLibVR/commit/ad8606599fc7347c9cccefe2da75f9d1ebb4ff20))

### Performance Improvements

* address ai suggestions ([80f72e4](https://github.com/QTR-Modding/CommonLibVR/commit/80f72e442f080aa5a1840124a4abb6105f6343fe))
* make all relocations static ([f62a94d](https://github.com/QTR-Modding/CommonLibVR/commit/f62a94d27a21d7747516a51a9d759424a222deee))
* make more relocations static ([c19a5b4](https://github.com/QTR-Modding/CommonLibVR/commit/c19a5b46efb8d84e651df69cd10a47e981b5ed0a))
* make more relocations static ([bd9cb72](https://github.com/QTR-Modding/CommonLibVR/commit/bd9cb721d5bbfef5a74e10dd677afb8fed584f5c))

### Reverts

* Revert incompatible upstream changes ([a8fa182](https://github.com/QTR-Modding/CommonLibVR/commit/a8fa1828fa7c1e941127cdac5a41da4dbac0bc1e))
